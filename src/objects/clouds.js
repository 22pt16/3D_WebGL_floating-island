...
export function createClouds(scene, clouds) {
  ...
  const cloudLayers = 4; // More layers for natural height depth
...
export function animateClouds(clouds) {
  clouds.forEach((cloud) => {
    ...
    //  BOUNDARY RESET FOR NATURAL LOOP
